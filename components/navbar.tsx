...
export function Navbar() {
  ...
  const { isAuthenticated, isAdminAuthenticated, setIsAuthenticated, setIsAdminAuthenticated } = useAuth();
  ...
  return (
    ...
    <div className="container mx-auto px-4 h-16 flex items-center justify-between relative">
      <Link href="/" className="font-semibold text-xl" onClick={closeDrawer}>
        <div className="flex items-center gap-4">
          <Image
            ...
            alt=""
            width={50} // Set explicit width and height
            height={30}
      ...
      >
        ...
        >
          <X className="h-6 w-6 text-white" /> {/* Added text-white for visibility */}
        </button>
